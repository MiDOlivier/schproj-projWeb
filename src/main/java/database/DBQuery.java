...
public class DBQuery {
	...
	public int insert(String[] values) {
		...
		if ( values.length == this.fieldsName.length){
			...
			System.out.print("O n�ｿｽmero de valores informados n�ｿｽo �ｿｽ equivalente aos campos da tabela!");
		}	
		return 0;
	}
	...
	public int delete(String[] values) {
		if (values.length != this.fieldsName.length){
			System.out.println("\n A quantidade de campos �ｿｽ diferente da quantidade de valores!");
			return ( 0 );
		}
